...
<nav class="tabs" id="mainTabs" role="tablist" aria-label="Dashboard sections">
  ...
  <button class="tab" role="tab" aria-selected="false" aria-controls="tab-prowler" onclick="switchTab('prowler')">CSPM</button>
  <button class="tab" role="tab" aria-selected="false" aria-controls="tab-github" onclick="switchTab('github')">GitHub</button>
  <button class="tab" role="tab" aria-selected="false" aria-controls="tab-bestpractices" onclick="switchTab('bestpractices')">Code Security</button>
  <button class="tab" role="tab" aria-selected="false" aria-controls="tab-arch" onclick="switchTab('arch')">Architecture</button>
  <button class="tab" role="tab" aria-selected="false" aria-controls="tab-networktools" onclick="switchTab('networktools')">Network</button>
</nav>
...
<div class="tab-panel active" id="tab-overview" role="tabpanel" aria-label="Overview">
  <!-- Stat pills -->
  <div class="stats-row">
    <div class="stat-pill sp-total"><div class="sp-icon">📊</div><div><div class="sp-num">{{TOTAL_ISSUES}}</div><div class="sp-label">Findings</div></div></div>
    ...
    <div class="stat-pill sp-warn"><div class="sp-icon">⚠</div><div><div class="sp-num">{{N_WARN}}</div><div class="sp-label">Warning</div></div></div>
  </div>
...
<!-- ── Tab: Code Security (OWASP + Compliance) ─────────────────────── -->
<div class="tab-panel" id="tab-bestpractices" role="tabpanel" aria-label="Code Security">
  <div class="card">
    <div class="card-title">OWASP Top 10:2025 + LLM Top 10:2025</div>
    <div style="padding:1rem 1.25rem">
      {{OWASP_HTML}}
    </div>
  </div>
