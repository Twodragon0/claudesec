...
| 2.11.4 | 사고 대응 훈련 및 개선 | 모의훈련, 개선 조치 |
| 2.11.5 | 사고 대응 및 복구 | 사고 대응, 원인 분석, 복구 |
...
**법적·거버넌스·인적 성격**이라 기술 스캐너가 자동으로 판정할 수 없습니다. NIST SP 800-53A는
...
> false-PASS**가 됩니다. NIST 800-53은 통제 목록이 이미 기술 통제 중심으로 큐레이션돼 있어
...
- 비평가 통제 집합은 단일 상수 `EXPECTED_NON_ASSESSABLE`로 관리되며, 프레임워크별 정확 일치로
